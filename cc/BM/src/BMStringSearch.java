...
//My aim is to implement BM matching using two shift rults:
//bad chacracter rule and good suffix rule
...
public class BMStringSearch{
    ...
    public static final void main(String[] args){
        ...
        BMStringSearch bm = new BMStringSearchBadChar();
...
class BMStringSearchBadChar extends BMStringSearch{
    
    private final int ASIZE = 256;
    private int[][] table;

    private void construct2DTable(int patternLength){
        table = new int[ASIZE][patternLength];
...
class BMStringSearchGoodSuf extends BMStringSearch{
